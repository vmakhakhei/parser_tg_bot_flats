...
- **Последний коммит:** `a7211a2` - Изменение задержки между отправкой объявлений: с 2 секунд на 1 секунду
...
- ✅ **Защита от Flood Control:** добавлена обработка TelegramRetryAfter и per-user rate limiting (коммит `[будет добавлен]`)
...
### Статистика
- **Файлов изменено:** 65+ (последний коммит: 8 файлов)
- **Строк добавлено:** +10,680+ (последний коммит: +159)
- **Строк удалено:** -466 (последний коммит: -45)
