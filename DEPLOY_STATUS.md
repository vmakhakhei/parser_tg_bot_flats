...
- ✅ **Упрощение логики активных пользователей и оптимизация парсинга** (коммит `[будет добавлен]`)
...
### Статистика
- **Файлов изменено:** 65+ (последний коммит: 5 файлов)
- **Строк добавлено:** +10,680+ (последний коммит: +223)
- **Строк удалено:** -466 (последний коммит: -22)
