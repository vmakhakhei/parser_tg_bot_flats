...
- **Последний коммит:** `0805123` - Исправление: добавлена защита от None сессии в HTTPClient
...
- ✅ **Критическое исправление:** защита от None сессии в HTTPClient (коммит `0805123`)
...
- **Коммитов:** 10+ (включая исправления парсинга, последние обновления и критическое исправление HTTPClient)
