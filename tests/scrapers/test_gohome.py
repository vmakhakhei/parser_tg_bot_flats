...
class TestGoHomeScraper:
    """Тесты для GoHomeScraper"""
    
    @pytest.fixture
    def scraper(self):
        """Фикстура для создания scraper"""
        return GoHomeScraper()
    
    @pytest.fixture
    def mock_html(self):
        """Фикстура для мока HTML страницы GoHome.by"""
        return """
        <html>
            <body>
                <div class="object-card">
                    <a href="/sale/flat/123456">2-комн. квартира, 50 м²</a>
    ...
    def test_parse_card_valid(self, scraper):
        ...
        if card:
            ...
            if listing:
                assert listing.source == "GoHome.by"
    ...
    def test_listing_dto_structure(self, scraper):
        ...
        listing.price = 50000
        listing.url = "https://gohome.by/sale/flat/123456"
        listing.address = "Минск, ул. Ленина, 1"
        listing.source = "gohome"
