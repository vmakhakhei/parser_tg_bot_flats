...
{{"selected": [{{"id": "listing_id", "reason": "МАКСИМАЛЬНО ДЕТАЛЬНОЕ И ПОДРОБНОЕ объяснение 8-12 предложений с конкретными цифрами, фактами и сравнениями. ОБЯЗАТЕЛЬНО включи все 6 разделов: 1) цена и соотношение цена/качество с сравнениями, 2) год постройки и техническое состояние, 3) район и расположение с преимуществами, 4) состояние ремонта, 5) особенности и преимущества, 6) сравнение с другими вариантами и общая оценка. Пиши КОНКРЕТНО, не общими фразами."}}]}}

Только JSON, без дополнительного текста. ОБЯЗАТЕЛЬНО минимум 5 вариантов."""
