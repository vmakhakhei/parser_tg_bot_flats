...
ВАЖНО: Сравнивай варианты с текущей ситуацией на рынке {city}:
• Какие цены за м² сейчас на рынке {city}?
• Насколько эти варианты выгодны по сравнению с типичными предложениями в {city}?
• Есть ли среди них действительно выгодные предложения или все в пределах нормы?
...
ОЦЕНКА (1-10) - сравнивай с РЫНКОМ {city.upper()}:
• Цена vs текущий рынок {city} (10=значительно ниже рынка, 5=в пределах рынка, 1=завышена)
• Год постройки (новее 2010г = бонус)
...
• Уникальность предложения (есть ли что-то особенное, что выделяет на рынке {city}?)

Выбери ТОП-{max_results} лучших (ТОЛЬКО ЦЕЛЫЕ КВАРТИРЫ!), учитывая их преимущества НА ФОНЕ ТЕКУЩЕГО РЫНКА {city.upper()}!
...
ФОРМАТ ОТВЕТА (строго JSON):
{{
  "analysis_summary": "Краткая сводка: сколько проанализировано, сравнение с текущим рынком {city}, общая ситуация на рынке {city}",
  "top_offers": [
    {{
