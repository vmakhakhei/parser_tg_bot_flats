...
{{
  ...
  "top_offers": [
    {{
      ...
      "critical_notes": ["⚠️ ОБЯЗАТЕЛЬНО укажи здесь ТОЛЬКО если это ТОЧНО ДОЛЯ или КОМНАТА (не целая квартира)! Формат: '⚠️ ДОЛЯ: 1/2 в двухкомнатной квартире' или '⚠️ КОМНАТА: комната в коммуналке'. Если это ЦЕЛАЯ КВАРТИРА — НЕ указывай долю/комнату, укажи другие недостатки или 'Нет критических недостатков'", "Другие недостатки (если есть)"]
    }}
  ],
  "best_overall": {{
